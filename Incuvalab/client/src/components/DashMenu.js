...
export function DashMenu() {
  ...
  return (
    <div className="flex">
      <React.Fragment>
        <div className={` ${open ? "w-95" : "w-20 "}flex bg-dark-red p-4 pt-8 relative`} Style="height: 2000px;">
          <img src={require('./images/assets/control.png')} alt="left_arrow"
      ...
      <div className="h-screen flex-1">
        <h1 className="text-2xl m-3 font-semibold ">Lista de Campañas</h1> <br />
